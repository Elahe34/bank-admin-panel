    ...
    <div dir='rtl'>
      ...
      <div className='flex justify-between items-center mb-10'> 
        ...
        <form onSubmit={handleSave} action="">
            ...
            <div className='mt-11' >
                <button type='submit' className='border border-green-600 ml-5 py-0.5 px-4 w-20 bg-green-500 text-white hover:bg-green-600 rounded hover:scale-110 transition-all
'>ذخیره</button>
                <button onClick={onClose} className='ml-5 w-20 rounded hover:scale-110 transition-all px-4 py-0.5 border border-gray-400 bg-gray-300 hover:bg-gray-400
'>لغو</button>
